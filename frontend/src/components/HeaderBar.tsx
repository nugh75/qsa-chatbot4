...
const HeaderBar: React.FC<HeaderBarProps> = ({
  ...
  const [desktopAnchor, setDesktopAnchor] = React.useState<null | HTMLElement>(
    null
  );
  ...
  const handleOpenDesktop = (e: React.MouseEvent<HTMLElement>) =>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {(() => {
            const current = safePersonalities.find(
            ...
            return (
              <Avatar
                src={src}
                alt={current?.name || "Bot"}
                sx={{ width: dense ? 30 : 36, height: dense ? 30 : 36 }}
              />
            );
          })()}
          <FormControl size="small" fullWidth>
            <Select
              ...
              onChange={(e) => onChangePersonality(e.target.value as string)}
              displayEmpty
              sx={{ fontSize: 14 }}
            >
        ...
        {!isMobile && (
          <>
            ...
            >
              ...
              >
                {isAuthenticated ? (userEmail ? `Logout (${userEmail})` : "Logout") : "Login"}
              </MenuItem>
            </Menu>
          </>
        )}
              ...
              <DialogContent dividers>
                ...
                >
                  <Typography variant="body2">
                    ...
                    {adminPersonalityInfo.provider || "-"}
                  </Typography>
                  <Typography variant="body2">
                    <strong>Modello:</strong>{" "}
                    {adminPersonalityInfo.model || "-"}
                  </Typography>
                  <Typography variant="body2">
                    <strong>Prompt:</strong>{" "}
                    {adminPersonalityInfo.systemPromptName || "-"}
                  </Typography>
                  <Box>
